  ...
  return (
    <div>
      <div className="absolute z-40 h-[calc(100vh-64px)] p-10">
        <p className="mb-16 mt-44 bg-gradient-to-r from-emerald-600 to-emerald-900 bg-clip-text px-8 text-center text-5xl font-semibold text-transparent sm:px-16 md:px-32 lg:text-6xl">
        ...
        <div className="mt-8 flex flex-row justify-center">
          <span
            className="absolute left-1/2 top-3/4 h-8 w-8 rotate-45 transform animate-arrow-down cursor-pointer border-b-2 border-l-2 border-slate-600"
            onClick={() => {
